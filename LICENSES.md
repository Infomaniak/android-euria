...
Euria for Android includes the following third-party libraries in the distributed application (runtime dependencies; test-only dependencies are excluded):
...
| [Firebase Cloud Messaging](https://firebase.google.com/docs/cloud-messaging) | [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0) |
